...
export const Maintenance = () => (
	<div
		className={`grid place-items-center bg-black grid-rows-[20px_1fr_20px] w-full min-h-1/2 p-8 pb-20 gap-16 sm:p-20 ${playfairDisplay.className}`}
	>
		<div className="flex flex-col gap-[32px] row-start-2 justify-center items-center">
			...
			<ul className="text-xl text-center sm:text-left not-last:mb-2">
				<li className="letter-spacing-[0.1em]  text-white">
