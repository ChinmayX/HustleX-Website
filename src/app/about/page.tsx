...
const About = () => (
	<div className="flex flex-col items-center w-full bg-white text-black">
		<Back />
		<div className="pb-20 w-5xl">
			<h1 className="text-6xl md:text-5xl font-bold leading-tight mt-12">
				Building the best
				<br />
			...
			<p className="text-lg text-justify md:text-xl font-light mt-8 leading-7">
			...
			<p className="text-lg text-justify md:text-xl font-light mt-4 leading-7">
